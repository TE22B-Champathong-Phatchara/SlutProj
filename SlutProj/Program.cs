...
List<People> guests = new List<People>{  
    ...
    new InvitedPerson { Age = 24, DateOfbirth = "19/10/2001" },
    new Imposter {Name = "Jane Doera", Age = 28, DateOfbirth= "12/09/1996"},
...
while(GuestIndex < guests.Count)
{
    ...
    while(true)
    {
        ...
        {
            System.Console.WriteLine("Day: 0\n");
            System.Console.WriteLine($"Person waited: {guests.Count - GuestIndex}");
        }
        ...
        if((Command == "kick" || Command.Contains("ki")) && !IsTurtorial)
        {
        ...
        {
            System.Console.WriteLine("\nDate: 10/2/2025\n");
            System.Console.WriteLine("List for invited people: ");

            InvitedPerson invited = new InvitedPerson();

            foreach(var name in invited.NameList)
            {
                System.Console.WriteLine(name);
            }

            // for (int i = GuestIndex; i < guests.Count; i++)
            // {
            //     System.Console.WriteLine(guests[i]);
            // }
            System.Console.WriteLine("\n[Enter] to continue");
            Console.ReadLine();
            Console.Clear();
